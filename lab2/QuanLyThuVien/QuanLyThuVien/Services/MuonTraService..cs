            ...
            decimal phiPhat)
        {
                    ...
                    IsolationLevel.Serializable))
            {
                try
                {
                    ...
                    {
                        return KetQuaXuLy.Loi(
                            "Trường hợp trả trễ/mất/hư hỏng phải nhập phí phạt lớn hơn 0.");
                    }
                    ...
                    // Bình thường -> trả lại kho
                    // Mất / Hư -> không trả lại kho
                    if (!mat && !huHong)
                    {
